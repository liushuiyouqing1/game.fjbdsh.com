...
class UserController extends AdminbaseController
{
	...
	public function index()
	{
		...
		$users = $this->users_model->where($where)->order("create_time DESC")->limit($page->firstRow, $page->listRows)->select();
	...
	public function userinfo_post()
	{
		if (IS_POST) {
			...
			$create_result = $this->users_model->field("id,user_nicename,sex,birthday,user_url,signature")->create();
