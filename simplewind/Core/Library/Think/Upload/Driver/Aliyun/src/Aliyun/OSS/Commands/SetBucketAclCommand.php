...
class SetBucketAclCommand extends OSSCommand
{
	protected function checkOptions($options)
	{
		...
		AssertUtils::assertSet(array(OSSOptions::BUCKET, OSSOptions::ACL), $options);
	...
	{
		return OSSRequestBuilder::factory()->setEndpoint($options[OSSOptions::ENDPOINT])->setBucket($options[OSSOptions::BUCKET])->addParameter('acl', null)->addHeader(OSSHeaders::OSS_CANNED_ACL, $options[OSSOptions::ACL])->setMethod(HttpMethods::PUT)->build();
	}
} 