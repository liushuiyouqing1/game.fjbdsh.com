...
class OSSUtils
{
	...
	private static $_metaOptions = array(OSSOptions::CACHE_CONTROL, OSSOptions::CONTENT_DISPOSITION, OSSOptions::CACHE_CONTROL, OSSOptions::CONTENT_ENCODING, OSSOptions::CONTENT_TYPE, OSSOptions::EXPIRES, OSSOptions::USER_METADATA,);
	...
	public static function populateOverrides(&$parameters, $options)
	{
		if (isset($options[OSSOptions::RESPONSE_CACHE_CONTROL])) {
			$parameters[ResponseHeaderOverrides::RESPONSE_HEADER_CACHE_CONTROL] = $options[OSSOptions::RESPONSE_CACHE_CONTROL];
		}
		if (isset($options[OSSOptions::RESPONSE_CONTENT_DISPOSITION])) {
			$parameters[ResponseHeaderOverrides::RESPONSE_HEADER_CONTENT_DISPOSITION] = $options[OSSOptions::RESPONSE_CONTENT_DISPOSITION];
		}
		if (isset($options[OSSOptions::RESPONSE_CONTENT_ENDCODING])) {
			$parameters[ResponseHeaderOverrides::RESPONSE_HEADER_CONTENT_ENCODING] = $options[OSSOptions::RESPONSE_CONTENT_ENDCODING];
		}
		if (isset($options[OSSOptions::RESPONSE_CONTENT_LANGUAGE])) {
			$parameters[ResponseHeaderOverrides::RESPONSE_HEADER_CONTENT_LANGUAGE] = $options[OSSOptions::RESPONSE_CONTENT_LANGUAGE];
		}
		if (isset($options[OSSOptions::RESPONSE_CONTENT_TYPE])) {
			$parameters[ResponseHeaderOverrides::RESPONSE_HEADER_CONTENT_TYPE] = $options[OSSOptions::RESPONSE_CONTENT_TYPE];
		}
		if (isset($options[OSSOptions::RESPONSE_EXPIRES])) {
			$parameters[ResponseHeaderOverrides::RESPONSE_HEADER_EXPIRES] = $options[OSSOptions::RESPONSE_EXPIRES];
		}
	}
