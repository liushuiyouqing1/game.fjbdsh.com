...
class PHPExcel_Chart
{
	...
	public function setTopLeftPosition($cell, $xOffset = null, $yOffset = null)
	{
		...
		if (!is_null($xOffset)) $this->setTopLeftXOffset($xOffset);
		if (!is_null($yOffset)) $this->setTopLeftYOffset($yOffset);
		return $this;
	}
	...
	public function setBottomRightPosition($cell, $xOffset = null, $yOffset = null)
	{
		...
		if (!is_null($xOffset)) $this->setBottomRightXOffset($xOffset);
		if (!is_null($yOffset)) $this->setBottomRightYOffset($yOffset);
		return $this;
	}
