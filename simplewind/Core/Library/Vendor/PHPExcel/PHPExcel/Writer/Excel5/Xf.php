...
class PHPExcel_Writer_Excel5_Xf
{
	...
	{
		if (isset(self::$_mapHAlign[$hAlign])) return self::$_mapHAlign[$hAlign];
		return 0;
	}
	...
	{
		if (isset(self::$_mapVAlign[$vAlign])) return self::$_mapVAlign[$vAlign];
		return 2;
	}
