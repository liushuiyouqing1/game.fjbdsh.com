...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
	...
	public function setTitle($pValue = 'Worksheet', $updateFormulaCellReferences = true)
	{
		...
		if ($this->_parent) {
			...
			if ($updateFormulaCellReferences) PHPExcel_ReferenceHelper::getInstance()->updateNamedFormulas($this->_parent, $oldTitle, $newTitle);
		}
		return $this;
	}
	...
	{
		if ($this->_tabColor === NULL) $this->_tabColor = new PHPExcel_Style_Color();
