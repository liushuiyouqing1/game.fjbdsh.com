...
<div class="main" style="">
  ...
  <img class='hb-bj' src="/themes/game/Public/img/redpackage/redpackage_bg.jpg"> 
  
    <div class='hb-bj-1' id="notopen">
        <img class='hb-bj-img' src="/themes/game/Public/img/redpackage/redpackage_new.png">
        ...
        <div class="btnOpen ling"  onclick="lingqufangka()">
            <img class='ling-img' src="/themes/game/Public/img/redpackage/rp_get.png">
        </div> 
    ...
    <div id="ropen" class='hb-display-zt'>
        <img src="/themes/game/Public/img/redpackage/redpackage_receive_new.png" class='hb-display-zt-img'>
