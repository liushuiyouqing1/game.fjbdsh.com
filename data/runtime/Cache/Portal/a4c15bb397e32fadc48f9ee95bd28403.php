...
<title><?php echo ($room["roomid"]); ?>号八倍九人房间</title>

<link rel="stylesheet" type="text/css" href="/app/css/bull_vue-2.0.3.css">
...
<script src="/app/js/game14.js" type="text/javascript"></script>
...
$(function() {  
  ...
  var title  = '<?php echo ($room["roomid"]); ?>号八倍九人房间';//分享的标题
...
"></div> 
   ...
   <div id="table" class="table">
    <img src="/app/img/bull9/table-8.jpg" class="tableBack" />
...
<audio onended="mp3playandpause('xia3');" id="xia3" src="/app/video/zhuang/3.mp3"></audio>
