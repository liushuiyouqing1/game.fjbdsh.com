...
<title><?php echo ($room["roomid"]); ?>号九人三公房间</title>

<link rel="stylesheet" type="text/css" href="/app/css/bullshop.css" /> 
  <link rel="stylesheet" type="text/css" href="/app/css/sangong9-1.0.css" /> 
  ...
  <link rel="stylesheet" type="text/css" href="/app/css/sangong9.css" /> 
<style>
.unready{
	    margin-top: 20px;
    width: 40px;
...
<script src="/app/js/game4.js" type="text/javascript"></script> 
...
$(function() {  
  ...
  var title  = '<?php echo ($room["roomid"]); ?>号九人三公房间';//分享的标题
...
<div id="valert2" class="alert">
  ...
  <?php exit(); endif; ?>
   ...
   <img src="/app/img/common/note5.png" class="return jiurenniuniu-return" onclick="opnemm('fangjian_tishi','tishi')"/> 
   <img src="/app/img/bull9/btn_game_rule.png" class="bGameRule jiurenniuniu-bGameRule" onclick="opnemm('fangjian_gz','vroomRule')" /> 
	<img src="/app/img/sangong9/btn_play_rule.png" class="bottomGameHistory" onclick="wanfas()" style="position: fixed;bottom: 0.75vh;right: 35vh;width: 4.5vh;z-index: 90;" />
...
"></div> 
   ...
   <div id="table" class="table">
    <img src="/app/img/sangong9/table9.jpg" class="tableBack" /> 
 ...
 <div class="myCards" style="display: none;"></div>
    ...
    <div id="" class="clock jiurenniuniu-clock">
     <img src="/app/img/bull9/bull_clock.png" class='jiurenniuniu-memberCoin' /> 
